...
.method private final parseSplitPairRule(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Landroidx/window/embedding/SplitPairRule;
    ...
    .line 178
    .local v3, "clearTop":Z
    new-instance v13, Landroidx/window/embedding/SplitAttributes$Builder;

    invoke-direct {v13}, Landroidx/window/embedding/SplitAttributes$Builder;-><init>()V

    .line 179
    sget-object v14, Landroidx/window/embedding/SplitAttributes$SplitType;->Companion:Landroidx/window/embedding/SplitAttributes$SplitType$Companion;

    invoke-virtual {v14, v4}, Landroidx/window/embedding/SplitAttributes$SplitType$Companion;->buildSplitTypeFromValue$window_release(F)Landroidx/window/embedding/SplitAttributes$SplitType;

    move-result-object v14

    invoke-virtual {v13, v14}, Landroidx/window/embedding/SplitAttributes$Builder;->setSplitType(Landroidx/window/embedding/SplitAttributes$SplitType;)Landroidx/window/embedding/SplitAttributes$Builder;

    move-result-object v13

    .line 181
    sget-object v14, Landroidx/window/embedding/SplitAttributes$LayoutDirection;->Companion:Landroidx/window/embedding/SplitAttributes$LayoutDirection$Companion;

    invoke-virtual {v14, v10}, Landroidx/window/embedding/SplitAttributes$LayoutDirection$Companion;->getLayoutDirectionFromValue$window_release(I)Landroidx/window/embedding/SplitAttributes$LayoutDirection;

    move-result-object v14

    .line 180
    invoke-virtual {v13, v14}, Landroidx/window/embedding/SplitAttributes$Builder;->setLayoutDirection(Landroidx/window/embedding/SplitAttributes$LayoutDirection;)Landroidx/window/embedding/SplitAttributes$Builder;

    move-result-object v13

    .line 183
    invoke-virtual {v13}, Landroidx/window/embedding/SplitAttributes$Builder;->build()Landroidx/window/embedding/SplitAttributes;
    ...
    .line 185
    .local v13, "defaultAttrs":Landroidx/window/embedding/SplitAttributes;
    new-instance v14, Landroidx/window/embedding/SplitPairRule$Builder;

    invoke-static {}, Lkotlin/collections/SetsKt;->emptySet()Ljava/util/Set;

    move-result-object v15

    invoke-direct {v14, v15}, Landroidx/window/embedding/SplitPairRule$Builder;-><init>(Ljava/util/Set;)V

    .line 186
    invoke-virtual {v14, v2}, Landroidx/window/embedding/SplitPairRule$Builder;->setTag(Ljava/lang/String;)Landroidx/window/embedding/SplitPairRule$Builder;

    move-result-object v14

    .line 187
    invoke-virtual {v14, v5}, Landroidx/window/embedding/SplitPairRule$Builder;->setMinWidthDp(I)Landroidx/window/embedding/SplitPairRule$Builder;

    move-result-object v14

    .line 188
    invoke-virtual {v14, v7}, Landroidx/window/embedding/SplitPairRule$Builder;->setMinHeightDp(I)Landroidx/window/embedding/SplitPairRule$Builder;

    move-result-object v14

    .line 189
    invoke-virtual {v14, v6}, Landroidx/window/embedding/SplitPairRule$Builder;->setMinSmallestWidthDp(I)Landroidx/window/embedding/SplitPairRule$Builder;
    ...
    invoke-virtual {v14, v15}, Landroidx/window/embedding/SplitPairRule$Builder;->setMaxAspectRatioInPortrait(Landroidx/window/embedding/EmbeddingAspectRatio;)Landroidx/window/embedding/SplitPairRule$Builder;
    ...
    invoke-virtual {v14, v15}, Landroidx/window/embedding/SplitPairRule$Builder;->setMaxAspectRatioInLandscape(Landroidx/window/embedding/EmbeddingAspectRatio;)Landroidx/window/embedding/SplitPairRule$Builder;
    ...
    .line 192
    invoke-virtual {v14, v15}, Landroidx/window/embedding/SplitPairRule$Builder;->setFinishPrimaryWithSecondary(Landroidx/window/embedding/SplitRule$FinishBehavior;)Landroidx/window/embedding/SplitPairRule$Builder;
    ...
    .line 194
    invoke-virtual {v14, v15}, Landroidx/window/embedding/SplitPairRule$Builder;->setFinishSecondaryWithPrimary(Landroidx/window/embedding/SplitRule$FinishBehavior;)Landroidx/window/embedding/SplitPairRule$Builder;

    move-result-object v14

    .line 196
    invoke-virtual {v14, v3}, Landroidx/window/embedding/SplitPairRule$Builder;->setClearTop(Z)Landroidx/window/embedding/SplitPairRule$Builder;

    move-result-object v14

    .line 197
    invoke-virtual {v14, v13}, Landroidx/window/embedding/SplitPairRule$Builder;->setDefaultSplitAttributes(Landroidx/window/embedding/SplitAttributes;)Landroidx/window/embedding/SplitPairRule$Builder;

    move-result-object v14

    .line 198
    invoke-virtual {v14}, Landroidx/window/embedding/SplitPairRule$Builder;->build()Landroidx/window/embedding/SplitPairRule;
    ...
    .end local v13    # "defaultAttrs":Landroidx/window/embedding/SplitAttributes;
    nop
...
.method private final parseSplitPlaceholderRule(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Landroidx/window/embedding/SplitPlaceholderRule;
    ...
    .line 223
    .local v5, "finishPrimaryWithPlaceholder":I
    ...
    .line 246
    .local v10, "maxAspectRatioInPortrait":F
    nop
    ...
    .line 250
    .local v11, "maxAspectRatioInLandscape":F
    nop
    ...
    invoke-virtual {v14, v6}, Landroidx/window/embedding/SplitAttributes$SplitType$Companion;->buildSplitTypeFromValue$window_release(F)Landroidx/window/embedding/SplitAttributes$SplitType;
    ...
    invoke-virtual {v14, v12}, Landroidx/window/embedding/SplitAttributes$LayoutDirection$Companion;->getLayoutDirectionFromValue$window_release(I)Landroidx/window/embedding/SplitAttributes$LayoutDirection;
    ...
    sget-object v15, Landroidx/window/embedding/RuleParser;->INSTANCE:Landroidx/window/embedding/RuleParser;
    ...
    .line 262
    invoke-direct {v15, v14, v0}, Landroidx/window/embedding/RuleParser;->buildClassName(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/content/ComponentName;

    move-result-object v0

    .line 267
    .local v0, "placeholderActivityClassName":Landroid/content/ComponentName;
    new-instance v15, Landroidx/window/embedding/SplitPlaceholderRule$Builder;
    ...
    .local v19, "placeholderActivityClassName":Landroid/content/ComponentName;
    const-string v0, "Intent().setComponent(pl\u2026eholderActivityClassName)"

    invoke-static {v4, v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    .line 267
    invoke-direct {v15, v1, v4}, Landroidx/window/embedding/SplitPlaceholderRule$Builder;-><init>(Ljava/util/Set;Landroid/content/Intent;)V

    .line 271
    invoke-virtual {v15, v2}, Landroidx/window/embedding/SplitPlaceholderRule$Builder;->setTag(Ljava/lang/String;)Landroidx/window/embedding/SplitPlaceholderRule$Builder;

    move-result-object v0

    .line 272
    invoke-virtual {v0, v7}, Landroidx/window/embedding/SplitPlaceholderRule$Builder;->setMinWidthDp(I)Landroidx/window/embedding/SplitPlaceholderRule$Builder;

    move-result-object v0

    .line 273
    invoke-virtual {v0, v9}, Landroidx/window/embedding/SplitPlaceholderRule$Builder;->setMinHeightDp(I)Landroidx/window/embedding/SplitPlaceholderRule$Builder;

    move-result-object v0

    .line 274
    invoke-virtual {v0, v8}, Landroidx/window/embedding/SplitPlaceholderRule$Builder;->setMinSmallestWidthDp(I)Landroidx/window/embedding/SplitPlaceholderRule$Builder;
    ...
    invoke-virtual {v1, v5}, Landroidx/window/embedding/SplitRule$FinishBehavior$Companion;->getFinishBehaviorFromValue$window_release(I)Landroidx/window/embedding/SplitRule$FinishBehavior;
    ...
    .line 280
    invoke-virtual {v0, v13}, Landroidx/window/embedding/SplitPlaceholderRule$Builder;->setDefaultSplitAttributes(Landroidx/window/embedding/SplitAttributes;)Landroidx/window/embedding/SplitPlaceholderRule$Builder;
    ...
    .line 210
    .end local v2    # "tag":Ljava/lang/String;
    .end local v3    # "stickyPlaceholder":Z
    .end local v5    # "finishPrimaryWithPlaceholder":I
    .end local v6    # "ratio":F
    .end local v7    # "minWidthDp":I
    .end local v8    # "minSmallestWidthDp":I
    .end local v9    # "minHeightDp":I
    .end local v10    # "maxAspectRatioInPortrait":F
    .end local v11    # "maxAspectRatioInLandscape":F
    .end local v12    # "layoutDir":I
    .end local v13    # "defaultAttrs":Landroidx/window/embedding/SplitAttributes;
    ...
    .end local v19    # "placeholderActivityClassName":Landroid/content/ComponentName;
    nop
    ...
    .restart local v3    # "stickyPlaceholder":Z
    .restart local v4    # "placeholderActivityIntentName":Ljava/lang/String;
    .restart local v5    # "finishPrimaryWithPlaceholder":I
    :cond_0
    move-object/from16 v16, v0
