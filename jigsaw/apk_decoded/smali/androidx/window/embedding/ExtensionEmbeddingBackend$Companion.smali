...
.method private final initAndVerifyEmbeddingExtension(Landroid/content/Context;)Landroidx/window/embedding/EmbeddingInterfaceCompat;
    ...
    .line 98
    .local v3, "$i$a$-let-ExtensionEmbeddingBackend$Companion$initAndVerifyEmbeddingExtension$1":I
    new-instance v4, Landroidx/window/embedding/EmbeddingCompat;

    .line 99
    sget-object v5, Landroidx/window/embedding/EmbeddingCompat;->Companion:Landroidx/window/embedding/EmbeddingCompat$Companion;

    invoke-virtual {v5}, Landroidx/window/embedding/EmbeddingCompat$Companion;->embeddingComponent()Landroidx/window/extensions/embedding/ActivityEmbeddingComponent;
    ...
    new-instance v7, Landroidx/window/core/PredicateAdapter;

    invoke-direct {v7, v2}, Landroidx/window/core/PredicateAdapter;-><init>(Ljava/lang/ClassLoader;)V

    invoke-direct {v6, v7}, Landroidx/window/embedding/EmbeddingAdapter;-><init>(Landroidx/window/core/PredicateAdapter;)V
    ...
    .line 98
    invoke-direct {v4, v5, v6, v7, p1}, Landroidx/window/embedding/EmbeddingCompat;-><init>(Landroidx/window/extensions/embedding/ActivityEmbeddingComponent;Landroidx/window/embedding/EmbeddingAdapter;Landroidx/window/core/ConsumerAdapter;Landroid/content/Context;)V

    .line 97
    .end local v2    # "loader":Ljava/lang/ClassLoader;
    .end local v3    # "$i$a$-let-ExtensionEmbeddingBackend$Companion$initAndVerifyEmbeddingExtension$1":I
    goto :goto_0
