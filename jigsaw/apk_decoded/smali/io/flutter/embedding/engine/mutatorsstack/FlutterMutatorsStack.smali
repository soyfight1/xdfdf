...
.method public pushClipRRect(IIII[F)V
    ...
    new-instance v1, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack$FlutterMutator;

    invoke-direct {v1, p0, v0, p5}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack$FlutterMutator;-><init>(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;Landroid/graphics/Rect;[F)V

    .line 183
    .local v1, "mutator":Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack$FlutterMutator;
    iget-object v2, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;->mutators:Ljava/util/List;
    ...
    .line 186
    iget-object v3, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;->finalMatrix:Landroid/graphics/Matrix;

    invoke-virtual {v2, v3}, Landroid/graphics/Path;->transform(Landroid/graphics/Matrix;)V

    .line 187
    iget-object v3, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;->finalClippingPaths:Ljava/util/List;
...
.method public pushClipRect(IIII)V
    ...
    invoke-direct {v1, p0, v0}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack$FlutterMutator;-><init>(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;Landroid/graphics/Rect;)V
...
.method public pushTransform([F)V
    ...
    invoke-direct {v1, p0, v0}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack$FlutterMutator;-><init>(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;Landroid/graphics/Matrix;)V
    ...
    .line 156
    iget-object v2, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;->finalMatrix:Landroid/graphics/Matrix;

    invoke-virtual {v1}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack$FlutterMutator;->getMatrix()Landroid/graphics/Matrix;
